...
## Oral talks
  ...
  *  <font size="4"> <b> Lost in Translation: Repurposing Semantic Similarity Benchmarks for Evaluating Lexical-Semantic Consistency in LLM-Based Machine Translation </b> </font>  
  [slides](./data/materials/ye_lost_slides.pdf)  
  ...
  *  <font size="4"> <b> Bridging the Low Resource Gap in Historical Cryptology: A Multilingual Diachronic Synthetic Dataset for Reproducible Cryptanalysis </b></font>
  [slides](./data/materials/bruton_bridging_slides.pdf)  
  ...
  *  <font size="4"> <b> Cultural Grounding in Swedish: Extending an Everyday Knowledge Benchmark for LLMs </b> </font>
  [slides](./data/materials/beloucif_cultural_slides.pdf)  
  ...
  *  <font size="4"> <b> Entity Linking for Faroese Using Large Language Models with Web Search </b> </font>
  [slides](./data/materials/simonsen_entity_slides.pdf)  
  ...
  *  <font size="4"> <b> From Polyester Girlfriends to Blind Mice: Creating the First Pragmatics Understanding Benchmarks for Slovene </b> </font>
  [slides](./data/materials/brglez_from_slides.pdf)  
  ...
  *  <font size="4"> <b> SdQuAD: A Benchmark Question Answering Dataset for Low-resource Sindhi Language </b> </font>
  [slides](./data/materials/ali_sdquad_slides.pdf)  
  ...
  *  <font size="4"> <b> LLMs as Assistants for Data Annotation: Addressing Disagreement and Supporting Expert Processes </b> </font>
  [slides](./data/materials/andrade_llms_slides.pdf)  
  ...
  *  <font size="4"> <b> Annotation Quality in Aspect-Based Sentiment Analysis: A Case Study Comparing Experts, Students, Crowdworkers, and Large Language Models </b> </font>
  [slides](./data/materials/donhauser_annotation_slides.pdf)  
...
## Posters
  ...
  *  <font size="4"> <b> Cross-Lingual Mathematical Reasoning in LLMs: Evaluating Performance on Icelandic vs. English Problems </b> </font>
  [poster](./data/materials/einarsson_cross-lingual_poster.pdf)  
  ...
  *  <font size="4"> <b> Struct2Unstruct: Creating Tender NER Datasets from Structured Procurement Records using Large Language Models </b> </font>
  [slides](./data/materials/asim_struct2unstruct_slides.pdf)  
  [poster](./data/materials/asim_struct2unstruct_poster.pdf)  
  [video](./data/materials/asim_struct2unstruct_video-compressed.mp4)  
  ...
  *  <font size="4"> <b> Link Prediction for Event Logs in the Process Industry </b> </font>
  [poster 1](./data/materials/zhukova_link_poster.pdf)  
  [poster 2](./data/materials/zhukova_link_poster2.pdf)  
  ...
  *  <font size="4"> <b> MultiZebraLogic: A Multilingual Logical Reasoning Benchmark </b> </font>  
  [poster 1](./data/materials/bruun_multizebralogic_poster.pdf)  
  [poster 2](./data/materials/bruun_multizebralogic_poster2.pdf)  
  [video 1](./data/materials/bruun_multizebralogic_video-compressed.mp4)  
  [video 2](./data/materials/bruun_multizebralogic_video2-compressed.mp4)  
  ...
  *  <font size="4"> <b> Progressing beyond Art Masterpieces or Touristic Clichés: how to assess your LLMs for cultural alignment? </b> </font>  
  [poster](./data/materials/branco_progressing_poster.pdf)  
  ...
  *  <font size="4"> <b> Evaluating Large Language Model-based Natural Language Generation for Modular Dialog systems </b> </font>
  [poster](./data/materials/emmerling_evaluating_posterslide.pdf)  
...
Generative AI assumed in current state-of-the-art literature.</div>
  ...
  *  <font size="4"> <b> Evaluating the Impact of LLM-Assisted Annotation in a Perspectivized Setting: the Case of FrameNet Annotation </b> </font>  
  [slides](./data/materials/belcavello_evaluating_slides.pdf)  
  [poster](./data/materials/belcavello_evaluating_poster.pdf)  
  ...
  *  <font size="4"> <b> A multilingual hallucination benchmark: MultiWikiQHalluA </b> </font>
  [slides](./data/materials/thoresen_a_slides.pdf)  
  [poster](./data/materials/thoresen_a_poster.pdf)  
  ...
  *  <font size="4"> <b> Exploring the similarities and differences between VLM-driven and traditional OCR for Historical Swedish Data </b> </font>  
  [poster](./data/materials/johansson_exploring_poster.pdf)  
